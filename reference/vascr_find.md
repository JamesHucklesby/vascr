...
#> ! [NA] corrected to [A01]. Please check the arguments for your functions are correctly typed.
#> [1] "A01"
...
#> ! [5000 cells] corrected to [5,000_cells + HCMEC D3_line]. Please check the arguments for your functions are correctly typed.
...
#> ! [NA] corrected to [1 : Experiment 1]. Please check the arguments for your functions are correctly typed.
#> [1] "1 : Experiment 1"
