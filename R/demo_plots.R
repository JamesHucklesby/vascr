...
growth1.df = ecis_import(raw1, modeled1, key1)
growth2.df = ecis_import(raw2, modeled2, key2)
growth3.df = ecis_import(raw3, modeled3, key3)

# Fix experimental names
growth1.df$Experiment = "One"
growth2.df$Experiment = "Two"
growth3.df$Experiment = "Three"
