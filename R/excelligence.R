...
fulldata2 = xcell_import()

exploded = ecis_explode(fulldata)
imploded = ecis_implode(fulldata)

toydata = ecis_subset(fulldata2, samplecontains = "Adenosine")

ecis_plot(toydata, unit = "CI", frequency = 0 , replication = "experiments", normtime = 180, time = c(170,220))

ecis_plot(fulldata, unit = "CI", frequency = 0, preprocessed = TRUE, replication = "experiments", samplecontains = "Adenosine")
